...
class CallGraphDB:
    ...
    def get_full_call_paths(self, function_name: str, max_depth: int = 10, max_paths: int = 1000) -> Dict[str, Any]:
        """
        ...
        return {
            ...
            'performance': {
                ...
                'duplicates_removed': len(seen_full_paths) - len(full_paths) if is_truncated else 0,
